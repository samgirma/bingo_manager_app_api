  ...
  const loadData = async () => {
    try {
      const [analyticsResponse, transactionsResponse] = await Promise.all([
        ...
        apiService.getRechargeHistory(currentUser?.username),
      ]);
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.balanceSection}>
          <Text style={styles.balanceLabel}>Your Balance (ETB)</Text>
        ...
        <View style={styles.actionRow}>
          ...
          >
            ...
            <Text style={styles.actionText}>Add Center</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.actionCircle}
          ...
          <View style={styles.insightContent}>
            <View>
              ...
              <Text style={styles.insightDescription}>
                You have {analytics.activeCenters} active centers. Generated {analytics.todayGeneratedTopups.toLocaleString()} ETB in top-ups today.
              </Text>
            </View>
